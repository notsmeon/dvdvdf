...
@router.message(F.successful_payment.invoice_payload.startswith('footvipbyinline'))
...
@router.message(F.successful_payment.invoice_payload.startswith('footvipbycommand'))
async def on_successful_payment(message: Message):
    await message.answer("payment-successful\n\n LINK - https://t.me/+N5n3qEC1Db1mY2Qy")
...
@router.message(F.successful_payment.invoice_payload.startswith('hentaivip'))
async def on_successful_payment(message: Message):
...
@router.message(F.successful_payment.invoice_payload.startswith('dualaccess'))
async def on_successful_payment(message: Message):
