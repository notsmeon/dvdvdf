...
@router.message(F.successful_payment.invoice_payload.startswith('footvipbyinlin'))
...
async def preeedlozhka(callback: CallbackQuery):
       await callback.message.answer(text='You can send a photo/video/file right now and here '
                                     ...
                                     '(Your name will not be published, for your anonymity'
                                     'we erase the meta data.)\n\n' 
                                     '<b>Thank you in advance for this, as it saves me a lot of time!</b>💕🫂',
                                     parse_mode='HTML'
                                     )
...
async def neeeegr(message: Message):
       await message.answer(LEXICON['/help'])
...
@router.message(F.successful_payment.invoice_payload.startswith('footvipbycomman'))
async def on_successful_payment(message: Message):
    await message.answer("payment-successful\n\n LINK - https://t.me/+N5n3qEC1Db1mY2Qy")
...
@router.message(F.successful_payment.invoice_payload.startswith('hentaivi'))
async def on_successful_payment(message: Message):
    await message.answer("payment-successful\n\n LINK - https://t.me/+LXmrmpyUKF42Yjky")
...
@router.message(F.successful_payment.invoice_payload.startswith('dualacces'))
async def on_successful_payment(message: Message):
    await message.answer("payment-successful\n\n LINKs - https://t.me/+N5n3qEC1Db1mY2Qy + https://t.me/+LXmrmpyUKF42Yjky")
...
async def hent_catalog(message: Message, bot: Bot):
      await bot.send_photo(chat_id=message.from_user.id, caption=hent_description,
